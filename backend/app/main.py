...
from app.routers import chat, documents, files, mcp, models, sessions, shell, skills, templates
...
async def get_config() -> dict:
    """Retourne la configuration courante (sans secrets)."""
    return {
        "ollama_base_url": settings.ollama_base_url,
        "ollama_api_mode": settings.ollama_api_mode,
        "ollama_default_model": settings.ollama_default_model,
        "workspace_root": str(settings.workspace_root),
        "shell_timeout": settings.shell_timeout,
        "max_chunks_context": settings.max_chunks_context,
    }
